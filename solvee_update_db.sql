...
MySQL - 10.1.35-MariaDB : Database - solvee
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`solvee` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `kategoripengaduans` */

DROP TABLE IF EXISTS `kategoripengaduans`;

CREATE TABLE `kategoripengaduans` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

/*Data for the table `kategoripengaduans` */

insert  into `kategoripengaduans`(`id`,`name`) values 
(1,'Infrastruktur'),
(2,'Kesehatan'),
(3,'Kebersihan'),
(4,'Pendidikan'),
...
('user@user.com','$2y$10$tRD4.5W6zkN0sas8hYxnu.KAMEner/5JR.J/oY.UwMo/Onl8Ix4gi','2020-04-28 02:42:35'),
('wiro@sigurita.com','$2y$10$1GNWLWPw9rf792NbT76J4utGPp4z4EQhoc3d3GFHXcwmyjTR5gEDe','2020-05-19 15:33:36');
...
CREATE TABLE `pengaduans` (
  ...
  `lokasi_pengaduan` varchar(100) NOT NULL,
  `deskripsi` text NOT NULL,
  `image` mediumtext,
  `status_pengaduan` varchar(100) DEFAULT 'belum diproses',
  `tanggal` date DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `nama` varchar(100) NOT NULL,
  `diteruskan_ke` varchar(100) DEFAULT NULL,
  `alasan_diteruskan` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

/*Data for the table `pengaduans` */

insert  into `pengaduans`(`id`,`nik`,`judul`,`kategori_pengaduan`,`provinsi`,`kabupaten`,`kecamatan`,`desa`,`lokasi_pengaduan`,`deskripsi`,`image`,`status_pengaduan`,`tanggal`,`created_at`,`updated_at`,`nama`,`diteruskan_ke`,`alasan_diteruskan`) values 
(2,1122334455667788,'fff','Kebersihan','Sumatera Utara','kkk','Laguboti','Sitoluama','depan del','eeee',NULL,'diteruskan','0000-00-00','2020-05-05 08:33:30','2020-05-06 16:36:42','',NULL,NULL),
(3,1122334455667788,'eeeee','Kesehatan','71','Kabupaten Padang Lawas Utara','1206040','Pintu Bosi','depan del','eeee',NULL,'diterima','0000-00-00','2020-05-05 08:36:44','2020-05-06 02:36:06','',NULL,NULL),
(4,1122334455667788,'eeeee','Kesehatan','71','1206','1206040','Pintu Bosi','depan del','eeee',NULL,'diterima','0000-00-00','2020-05-05 08:36:56','2020-05-09 16:10:02','',NULL,'karena'),
(5,1122334455667788,'eeeeer','Kebersihan','Sumatera Utara','Kabupaten Toba Samosir','Laguboti','Sitoluama','depan del','xxxxxxxx',NULL,'diteruskan','0000-00-00','2020-05-08 10:06:01','2020-05-09 16:07:18','',NULL,'karena'),
(7,1212007420047001,'kerusakan','Kesehatan','Sumatera Utara','Kabupaten Toba Samosir','Laguboti','Sitoluama','kampus institut teknologi del','eeeeeeee',NULL,'diteruskan','2020-05-09','2020-05-09 14:24:04','2020-05-09 16:11:39','Generic',NULL,'karena'),
(8,1111111111111111,'kerusakan','Infrastruktur','Sumatera Utara','Kabupaten Toba Samosir','Laguboti','Sitoluama','depan del','eeeee',NULL,'belum diproses',NULL,NULL,NULL,'jaka',NULL,NULL);
...
(1,1,1,'2020-04-27 21:31:09',NULL),
(2,2,2,'2020-04-27 21:32:24',NULL),
(3,3,3,'2020-04-27 21:32:28',NULL),
(4,3,5,'2020-05-21 12:31:42',NULL);
...
(1,'admin','2020-04-27 14:31:08','2020-04-27 14:31:08'),
(2,'Pemerintah Kecamatan Laguboti','2020-05-06 22:34:02','2020-04-27 14:31:08'),
(3,'user','2020-04-27 14:31:08','2020-04-27 14:31:08'),
(4,'Pemerintah Desa Sitoluama','2020-05-06 22:58:35','2020-05-06 22:58:44');
...
insert  into `users`(`id`,`name`,`email`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`,`nik`,`alamat`,`nomor_telepon`,`jenis_kelamin`) values 
(1,'Admin','admin@admin.com',NULL,'$2y$10$VoAIRyt98xMajWoXV7QO3eVfLmwBlhYGe3MAncLusHwZL0Z4iyDOC',NULL,'2020-04-27 14:31:09','2020-04-27 15:19:51',0,NULL,NULL,NULL),
(2,'Pemerintah Kecamatan Laguboti','author@author.com',NULL,'$2y$10$brnXj1OmmMuFUaaObc2OSO9fv2wH136WGdO4Wh78U7u7N7vBHc2fG',NULL,'2020-04-27 14:31:09','2020-05-19 15:28:13',0,'Laguboti','3',NULL),
(3,'Generic','user@user.com',NULL,'$2y$10$nt/DCVxfMp1vZPtDswr4ru8vlplIpAOMOJ0rYfmSMewDWNUQnVzQq',NULL,'2020-04-27 14:31:09','2020-05-21 07:45:21',1212007420047001,'Sitoluama','0812','Laki-laki'),
(4,'Pemerintah Desa Sitoluama','wiro@sigurita.com',NULL,'$2y$10$ncm.AQTgNuOH7AmLQ8gXVOvSs300B0nhkAEAuQLor7o/96XmpOvrC',NULL,'2020-04-30 15:11:25','2020-05-19 15:29:53',0,'Sitoluama','081254323214',NULL),
(5,'jaka','jaka@sigurita.com',NULL,'$2y$10$fF3fw4z3Sb4PJBRMNM3AU.WstJcv4VDTjyAoqQq8DM/nKU0JLEKu6',NULL,'2020-05-21 05:21:25','2020-05-21 05:21:25',1111111111111111,NULL,NULL,NULL);
...
('1206051009','1206051','PA`homestead`NGURURAN II'),
